...
export default function getCarImageUrl(make: string, model: string) {
...
export  async function CarList({makeId, year}: CarListProps) {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        const imageUrl = getCarImageUrl(makeName, vehicle.Model_Name);
        return (
          <div
